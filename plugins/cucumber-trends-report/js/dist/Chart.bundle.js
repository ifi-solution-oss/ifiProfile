/*!
 * Chart.org.jenkinsci.plugins.cucumbertrendsreport.ui.js
 * http://chartjs.org/
 * Version: 2.1.6
 *
 * Copyright 2016 Nick Downie
 * Released under the MIT license
 * https://github.com/chartjs/Chart.org.jenkinsci.plugins.cucumbertrendsreport.ui.js/blob/master/LICENSE.md
 */
...
Color.prototype = {
	...
	clone: function () {
		...
		// making the final build way to big to embed in Chart.org.jenkinsci.plugins.cucumbertrendsreport.ui.js. So let's do it manually,
...
//! moment.org.jenkinsci.plugins.cucumbertrendsreport.ui.js
//! version : 2.13.0
//! authors : Tim Wood, Iskren Chernev, Moment.org.jenkinsci.plugins.cucumbertrendsreport.ui.js contributors
//! license : MIT
//! momentjs.com
...
;(function (global, factory) {
    ...
    utils_hooks__hooks.createFromInputFallback = deprecate(
        'moment construction falls back to org.jenkinsci.plugins.cucumbertrendsreport.ui.js Date. This is ' +
    ...
    // from http://docs.closure-library.googlecode.com/git/closure_goog_date_date.org.jenkinsci.plugins.cucumbertrendsreport.ui.js.source.html
    ...
    function iso_string__toISOString() {
        ...
        // inspired by https://github.com/dordille/moment-isoduration/blob/master/moment.isoduration.org.jenkinsci.plugins.cucumbertrendsreport.ui.js
        var Y = years;
        var M = months;
        var D = days;
        var h = hours;
		...
		update: function update(reset) {
			...
			if (showLine) {
				...
				line._model = {
					...
					// to https://github.com/chartjs/Chart.org.jenkinsci.plugins.cucumbertrendsreport.ui.js/issues/2435#issuecomment-216718158
...
module.exports = function(Chart) {
	...
	//-- Basic org.jenkinsci.plugins.cucumbertrendsreport.ui.js utility methods
	...
	helpers.inherits = function(extensions) {
		//Basic javascript inheritance based on the model created in Backbone.org.jenkinsci.plugins.cucumbertrendsreport.ui.js
		var parent = this;
	...
	helpers.color = function(c) {
		if (!color) {
			console.log('Color.org.jenkinsci.plugins.cucumbertrendsreport.ui.js not found!');
			return c;
		}
...
module.exports = function(Chart) {
	...
	var TimeScale = Chart.Scale.extend({
		initialize: function() {
			if (!moment) {
				throw new Error('Chart.org.jenkinsci.plugins.cucumbertrendsreport.ui.js - Moment.org.jenkinsci.plugins.cucumbertrendsreport.ui.js could not be found! You must include it before Chart.org.jenkinsci.plugins.cucumbertrendsreport.ui.js to use the time scale. Download at https://momentjs.com');
			}
		...
		parseTime: function(label) {
			...
			if (typeof me.options.time.format !== 'string' && me.options.time.format.call) {
				console.warn("options.time.format is deprecated and replaced by options.time.parser. See http://nnnick.github.io/Chart.org.jenkinsci.plugins.cucumbertrendsreport.ui.js/docs-v2/#scales-time-scale");
